(function(){
  ...
  var ray_container = iD('logo-rays-container')
  ...
  var shield3Container = iD('shield3-container');
  var shield4 = iD('shield4');
  ...
  function playBan(){
    ...
    playCount++;
    //Velocity(duration: 14000, delay: 1400, complete: closeAnim});
  ...
  function scene4(){
   ...
   Velocity(textContainer3, {opacity: [0, 1], translateY: ['-10px', '0px']}, {duration: 300, delay: 0, complete: scene5});
  }

  function scene5() {
	Velocity(shield4, {opacity: [1, 0]}, {duration: 700, delay: 0});
	Velocity(textSet4, {translateY: ['0px', '28px']}, {duration: 700, delay: 0});
    Velocity(cta, {opacity: [1, 0]}, {duration: 1000, delay: 0})
    Velocity(logo, {opacity: [1, 0]}, {duration: 1000, delay: 0})
	Velocity(ray_container, {bottom: 7}, {duration: 1000, delay: 0})
